...
printf '%s\n' "$FUSION_OUT" | grep -E '^(EFFECTIVE_BACKENDS|ORCHESTRATOR_FAMILY|JUDGE_DEFAULT|SYNTH_DEFAULT|FUSION_CAPABILITY|MODEL_READY_GLM|CODEX_BACKEND_READY|OPENCODE_BACKEND_READY|AGY_BACKEND_READY|CLAUDE_BACKEND_READY)=' || true
