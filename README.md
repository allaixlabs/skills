...
- **프로젝트별**: Setup의 'Codex 어댑터' 선택 또는 `cp loop-md/templates/AGENTS.md.tmpl <프로젝트>/AGENTS.md`.
Codex는 `loop.md`가 없으면 `detect-stack.sh`로 직접 부트스트랩(Setup+Verify 단독 수행)도 가능하다.
