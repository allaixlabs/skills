...
- REPORT 직전 `council_wt_cleanup "<root>" "$RUN"` 1회 호출
- **누수 점검**: `git -C "<root>" worktree list`에 council worktree 잔존 0 + `git -C "<root>" branch --list 'council/*'`에 council 브랜치 잔존 0 확인(1줄)
